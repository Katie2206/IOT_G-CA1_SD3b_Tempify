...
class User(db.Model):
    ...
    def __init__(self, User_ID, Username, Password, Email_Address, Token, Read_Access, Write_Access):
...
def add_user_and_login(Username, User_ID, Password, Email_Address):
    ...
    if row is not False:
        ...
        new_user = User(Username, User_ID, Password, Email_Address, None, 0, 0)
